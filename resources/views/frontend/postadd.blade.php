            ...
            <div class="page-content" >
                <div class="container" style="background-color: white;">
                    ...
                    <div class="col-md-3">
                                ...
                                <a href="{{route('bookadd')}}"><button type="button" class="btn btn-success btn-sm" style="margin-bottom:15px;">Post Add</button></a>
                        ...
                        <section class="product-wrapper" style="margin-top: 15px;margin-bottom:25px;">
                            <form>
                                ...
                                <div class="form-group">
                                  <label for="inputAddress" style="font-weight: bold;color: black;">Subject</label>
                                  <input type="text" class="form-control" id="inputAddress" placeholder="Novel">
                                </div>
