                ...
                <div class="container" style="background-color: white;">
                    <div class="row">
                        <div class="col-md-12" style="margin-top:30px;">
                            ...
                            <a href="{{route('postadd')}}"><button type="button" class="btn btn-success btn-sm" style="margin-bottom:15px;">Post Add</button></a>
    ...
    <div class="accordion" id="accordionExample">
        ...
        <div class="accordion-item">
            ...
            <ul data-testid="li-wrapper" role="listbox" aria-labelledby="dropdown-label-2" tabindex="-1">
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG dd-li-active--2hPPi list-highlight--mnSxu" id="all_posters" role="option">University</li>
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG" id="only_members" role="option">College</li>
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG" id="only_members" role="option">School</li>
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG" id="only_members" role="option">Forum</li>
...
<div class="accordion-item">
    ...
    <div id="collapsefive" class="accordion-collapse collapse " aria-labelledby="headingfive" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            <ul data-testid="li-wrapper" role="listbox" aria-labelledby="dropdown-label-2" tabindex="-1">
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG dd-li-active--2hPPi list-highlight--mnSxu" id="all_posters" role="option">2020</li>
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG" id="only_members" role="option">2019</li>
...
<div class="accordion-item">
    ...
    <div id="collapsesix" class="accordion-collapse collapse " aria-labelledby="headingfive" data-bs-parent="#accordionExample">
        <div class="accordion-body">
            <ul data-testid="li-wrapper" role="listbox" aria-labelledby="dropdown-label-2" tabindex="-1">
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG dd-li-active--2hPPi list-highlight--mnSxu" id="all_posters" role="option">Novel</li>
                <li class="dd-list-item--shau1 list-highlight-focus--1t1-X list-highlight-hover--1swxG" id="only_members" role="option">Academic</li>
